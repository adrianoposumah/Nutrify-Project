...
function CarouselPrevious({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute size-10 rounded-full", orientation === "horizontal" ? "top-1000/2857 -left-5 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90", className)}
...
function CarouselNext({ className, variant = "outline", size = "icon", ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute size-10 rounded-full", orientation === "horizontal" ? "top-1000/2857 -right-5 -translate-y-1/2" : "-bottom-12 left-1/2 -translate-x-1/2 rotate-90", className)}
